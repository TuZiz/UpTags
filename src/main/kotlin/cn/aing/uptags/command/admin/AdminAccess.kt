...
object AdminAccess {
    ...
    const val CUSTOM_ORDERS = "uptags.admin.custom.orders"
    const val CUSTOM_REFUND = "uptags.admin.custom.refund"
    const val CUSTOM_COMPLETE = "uptags.admin.custom.complete"
